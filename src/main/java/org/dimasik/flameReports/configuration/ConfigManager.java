package org.dimasik.flameReports.configuration;
...
public class ConfigManager {
    private static final Map<String, FileConfiguration> configCache = new HashMap<>();
    private static FlameReports plugin;

    public static void init(FlameReports plugin) {
    ...
    public static ConfigurationSection getConfigurationSection(String filePath, String path) {
        FileConfiguration config = getCachedConfiguration(filePath);
